...
def cover():
    print """
     ...
     """
    runntek(GL+"       SELAMAT DATANG DI TOOLS CRACK FB.. ^_^...")
    time.sleep(1)
    print " "
    print RR+"  +============================================+"
    print GG+"  |••••••••   TOOLS CRACK FB ^_^  •••••••••|" 
    print RR+"  +============================================+"
    print WW+"  |            MOD BY: RIANWK         |"
    print GG+"  |      Berdoa Dulu Sebelum Menggunakan       |"
    print WW+"  |            FACEBOOK: RianWk           |"
    print Y+"  |              INSTAGRAM: 2nd.yans      |"
    print WW+"  |--------------------------------------------|"
...
email = str(raw_input(GL+" •Masukkan ID Korban\033[33;1m: "))

passwordlist = str(raw_input(WW+" •Masukkan File Berisi Wordlist \033[95m[ pass.txt ] \033[92;1m: "))
...
def main():
        ...
        search()
        print " "
        runntek(RR+"  Password Tidak Ada yang Cocok")
        runntek(RR+"  Bikin Wordlistnya Sendiri Lebih Praktis")
        time.sleep(1)
        print WW+34*"  -"
        kol()

def kol():
    nok = raw_input("Buat Wordlist.? \033[96;1m[y/n]: ")
    if nok == "y":
